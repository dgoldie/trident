defmodule Gateway.Utils.File do
  @moduledoc """
  This module provides several paths associated with Gateway and file operation.
  """

  @doc ~S"""
  Structure associated with file paths.
  ## Example
      iex> Gateway.Utils.File.__struct__
      %Gateway.Utils.File{export_path: "test/example", mapping_files: "mappings",
        play_path: "test/data", response_files: "__files"}
  """
  defstruct export_path: Application.get_env(:gateway, :export_path) || "default",
            play_path: Application.get_env(:gateway, :play_path) || "default",
  ...
  ## Exmaple
      iex> Gateway.Utils.File.get_export_path
      "test/example/mappings"
      iex> Gateway.Utils.File.get_export_path(8080)
      "test/example/8080/mappings"
      iex> Gateway.Utils.File.get_export_path("8080")
      "test/example/8080/mappings"
      iex> Gateway.Utils.File.get_export_binary_path
      "test/example/__files"
      iex> Gateway.Utils.File.get_export_binary_path(8080)
      "test/example/8080/__files"
      iex> Gateway.Utils.File.get_export_binary_path("8080")
      "test/example/8080/__files"
      iex> Gateway.Utils.File.get_response_path
      "test/data/__files"
      iex> Gateway.Utils.File.get_mapping_path
      "test/data/mappings"
  """
  ...
  defp export_path(), do: %GatewayFile{}.export_path
  defp play_path(), do: %GatewayFile{}.play_path
  defp response_files(), do: %GatewayFile{}.response_files
  defp mapping_files(), do: %GatewayFile{}.mapping_files

  @doc ~S"""
  Generate json file name with `:rand.uniform`
  ## Example
      iex> Gateway.Utils.File.filename(["path", "info", "path"]) |> String.match?(~r(\Apath-info-path.*\.json\z))
      true
      iex> Gateway.Utils.File.filename("path-info-path") |> String.match?(~r(\Apath-info-path.*\.json\z))
      true
  """
  ...
  ## Example
      iex> Gateway.Utils.File.read_json_file!("test/data/mappings/sample.json")
  ...
  ## Example
      iex> Gateway.Utils.File.json_files!("test/data/mappings") |> Enum.sort
      ["test/data/mappings/sample.json", "test/data/mappings/sample2.json", "test/data/mappings/sample3.json"]
      iex> {:ok, paths} = Gateway.Utils.File.json_files("test/data/mappings")
      iex> paths |> Enum.sort
      ["test/data/mappings/sample.json", "test/data/mappings/sample2.json", "test/data/mappings/sample3.json"]
  """
