defmodule  Gateway.Play.Paths do
  @moduledoc """
  Gateway.Play.Paths is structure for play response mode.
  The structure gets paths as list via Gateway.Play.Response.play_paths.
  """
  ...
  ## Example
      iex> Gateway.Play.Paths.path_patterns
      ["\\A/request.*neko\\z"]
  """
